...
//        typedef typename uv_filesystem_i::close_cb       close_cb;
        ...
        class uv_filesystem : public filesystem<uv_stat_t, uv_file, std::vector<uint8_t>>
        {
        private:
            uv_loop_t *_uv_loop;
        ...
        public:
            ...
            int read(uv_file &file, vector<uint8_t> &buf, off64_t off, read_cb cb) noexcept override;
            int write(uv_file &file, vector<uint8_t> &buf, off64_t off, write_cb cb) noexcept override;
