//#ifndef OBJD_CPP_UV_FS_FILESYSTEM_H
//#define OBJD_CPP_UV_FS_FILESYSTEM_H
//
//#include <uv.h>
//#include <memory>
//#include <objd-fs/fs/filesystem.hpp>
//
//namespace objd::fs::uv
//{
...
//        };
//
//        int exists(path &path, exists_cb cb) noexcept override
//        {
...
//        };
//
//        int stat(path &path, stat_cb cb) noexcept override
//        {
//            uv_fs_t *r = new uv_fs_t {
...
//        };
//
//        int mkdir(path &path, mode_t mode, mkdir_cb cb) noexcept override
//        {
//            uv_fs_t *r = new uv_fs_t {
...
//        };
//
//        int mkdirs(path &path, mode_t mode, mkdirs_cb cb) noexcept override
//        {
//            uv_fs_t *r = new uv_fs_t {
...
////
////            mkdirs_cb recursive_cb = [this, data](objd::fs::path &p, int err)
////            {
////                if (err == ENOENT)
////                {
////                    objd::fs::path parent = p.parent();
////                    mkdirs(parent, data->mode, [this, data](objd::fs::path &p2, int err2)
////                    {
...
//        };
//
//        int create(path &path, mode_t mode, create_cb cb) noexcept override
//        {
//            uv_fs_t *r = new uv_fs_t {
...
//        };
//
//        int open(path &path, mode_t mode, int flags, open_cb cb) noexcept override
//        {
//            uv_fs_t *r = new uv_fs_t {
...
//        };
//
//        int fstat(file_t &file, fstat_cb cb) noexcept override
//        {
//            uv_fs_t *r = new uv_fs_t {
...
//        };
//
//        int read(file_t &file, buf_t &buf, read_cb cb) noexcept override
//        {
//            uv_fs_t *r = new uv_fs_t {
...
//        };
//
//        int write(file_t &file, buf_t &buf, write_cb cb) noexcept override
//        {
//            uv_fs_t *r = new uv_fs_t {
...
//        };
//
//        int close(file_t &file, close_cb cb) noexcept override
//        {
//            uv_fs_t *r = new uv_fs_t {
