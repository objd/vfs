...
namespace
{
    ...
    class t_copy
    {
      ...
      public:
        ...
        {
            _result = _uv_fs.copy(_path, _other_path, [this](vfs::any_path &path, vfs::any_path &other_path, int err)
            {
                _error_result = err;
            });
    ...
    TEST_CASE("[copy] It should copy file when other path does not exist", INTEGRATION_TEST_TAG)
    {
        t_copy t;
    ...
    TEST_CASE("[copy] It should copy file even if other path exist", INTEGRATION_TEST_TAG)
    {
        t_copy t;
    ...
    TEST_CASE("[copy] It should return enoent when path does not exist", INTEGRATION_TEST_TAG)
    {
        t_copy t;
